...
:file:    Balance_client.py
:authors: Florian Meinicke

:date: (creation)          2021-11-24T15:23:15.549560
:date: (last modification) 2021-11-24T15:23:15.549560
...
from impl.de.cetoni.balance.BalanceService.BalanceService_client import BalanceServiceClient



# noinspection PyPep8Naming, PyUnusedLocal
class BalanceClient(SiLA2Client):
    """
        Allows to control a balance
    ...
    def __init__(self,
                 name: str = "BalanceClient", description: str = "Allows to control a balance",
        ...
        logging.info(
            f"Starting SiLA2 service client for service Balance with service name: {name}"
        )

        self.balance_service_client = BalanceServiceClient(self.channel)
...
def parse_command_line():
    ...
    """
    parser = argparse.ArgumentParser(description="A SiLA2 client: Balance")
...
if __name__ == '__main__':
    ...
    # start the server
    sila_client = BalanceClient(server_ip=parsed_args.server_ip_address,
