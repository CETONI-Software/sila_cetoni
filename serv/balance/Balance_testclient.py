...
:file:    Balance_testclient.py
:authors: Florian Meinicke

:date: (creation)          2021-11-24T15:23:15.555560
:date: (last modification) 2021-11-24T15:23:15.555560
...
def parse_command_line():
    ...
    parser = argparse.ArgumentParser(
        description="A SiLA2 test client for: Balance")
...
if __name__ == '__main__':
    ...
    # ----- de/cetoni/balance/BalanceService
    # results = sila_client.balance_service_client.Tare(EmptyParameter: bytes = b'')
    ...
    # ----- de/cetoni/balance/BalanceService
    # results = sila_client.balance_service_client.Subscribe_Value()
