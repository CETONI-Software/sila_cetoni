...
class PumpUnitController(object):
    """Feature: Pump Unit Controller
    Allows to control the currently used units for passing and retrieving flow rates and volumes to and from a pump.
    """

    @staticmethod
    def SetFlowUnit(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/sila2.de.cetoni.pumps.syringepumps.pumpunitcontroller.v1.PumpUnitController/SetFlowUnit',
            PumpUnitController__pb2.SetFlowUnit_Parameters.SerializeToString,
            PumpUnitController__pb2.SetFlowUnit_Responses.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def SetVolumeUnit(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/sila2.de.cetoni.pumps.syringepumps.pumpunitcontroller.v1.PumpUnitController/SetVolumeUnit',
            PumpUnitController__pb2.SetVolumeUnit_Parameters.SerializeToString,
            PumpUnitController__pb2.SetVolumeUnit_Responses.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def Subscribe_FlowUnit(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/sila2.de.cetoni.pumps.syringepumps.pumpunitcontroller.v1.PumpUnitController/Subscribe_FlowUnit',
            PumpUnitController__pb2.Subscribe_FlowUnit_Parameters.SerializeToString,
            PumpUnitController__pb2.Subscribe_FlowUnit_Responses.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def Subscribe_VolumeUnit(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/sila2.de.cetoni.pumps.syringepumps.pumpunitcontroller.v1.PumpUnitController/Subscribe_VolumeUnit',
            PumpUnitController__pb2.Subscribe_VolumeUnit_Parameters.SerializeToString,
            PumpUnitController__pb2.Subscribe_VolumeUnit_Responses.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
