...
:date: (last modification) 2021-10-05T09:04:08.770973
...
from impl.common.errors import SiLAFrameworkError, SiLAFrameworkErrorType, \
    QmixSDKSiLAError, DeviceError, SiLAError
...
class ControlLoopService(ControlLoopService_pb2_grpc.ControlLoopServiceServicer):
    ...
    def __init__(self, controller_channels: List[ControllerChannel], simulation_mode: bool = True):
        """
        Class initialiser.

        :param controller_channels: The channels that this feature can operate on
        :param simulation_mode: Sets whether at initialisation the simulation mode is active or the real mode.
        """

        self.channels = controller_channels
        self.num_channels = len(self.channels)
        self.uuid_to_controller: Dict[str, ControllerChannel] = dict()
    ...
    def WriteSetPoint(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            return self.implementation.WriteSetPoint(request, controller, context)
    ...
    def RunControlLoop(self, request, context: grpc.ServicerContext) \
        ...
        try:
            controller: ControllerChannel = self._get_channel(context.invocation_metadata(), "Command")
            ...
            confirmation = self.implementation.RunControlLoop(request, controller, context)
            self.uuid_to_controller[confirmation.commandExecutionUUID.value] = controller
            return confirmation
    ...
    def Get_NumberOfChannels(self, request, context: grpc.ServicerContext) \
        ...
        Requests the unobservable property Number Of Channels
            The number of controller channels. This value is 0-indexed, i.e. the first channel has index 0, the second one index 1 and so on.

        :param request: An empty gRPC request object (properties have no parameters)
        :param context: gRPC :class:`~grpc.ServicerContext` object providing gRPC-specific information

        :returns: A response object with the following fields:
            NumberOfChannels (Number Of Channels): The number of controller channels. This value is 0-indexed, i.e. the first channel has index 0, the second one index 1 and so on.
        """
        ...
        return ControlLoopService_pb2.Get_NumberOfChannels_Responses(
    ...
    def Subscribe_ControllerValue(self, request, context: grpc.ServicerContext) \
        ...
        try:
            controller = self._get_channel(context.invocation_metadata(), "Property")
    ...
    def Get_FCPAffectedByMetadata_ChannelIndex(self, request, context: grpc.ServicerContext) \
        ...
        return ControlLoopService_pb2.Get_FCPAffectedByMetadata_ChannelIndex_Responses(
            AffectedCalls=[
                silaFW_pb2.String(value="de.cetoni/controllers/ControlLoopService/v1/Command/WriteSetPoint"),
                silaFW_pb2.String(value="de.cetoni/controllers/ControlLoopService/v1/Command/RunControlLoop"),
                silaFW_pb2.String(value="de.cetoni/controllers/ControlLoopService/v1/Command/StopControlLoop"),
                silaFW_pb2.String(value="de.cetoni/controllers/ControlLoopService/v1/Property/ControllerValue"),
                silaFW_pb2.String(value="de.cetoni/controllers/ControlLoopService/v1/Property/SetPointValue"),
            ]
        )
