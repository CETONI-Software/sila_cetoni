...
*Digital Out Channel Controller_defined_errors*

:details: DigitalOutChannelController Defined SiLA Error factories:
    Allows to control one digital output channel of an I/O module

:file:    DigitalOutChannelController_defined_errors.py
:authors: Florian Meinicke

:date: (creation)          2021-07-08T12:11:17.612614
:date: (last modification) 2021-07-08T12:11:17.612614
...
class InvalidChannelIndex(SiLAExecutionError):
    ...
    def __init__(self, channel_id: int = None, extra_message: str = ""):
        ...
        super().__init__(error_identifier="sila2.de.cetoni/io/DigitalOutChannelController/v1/DefinedError/InvalidChannelIndex",
                         msg=msg)
