...
:date: (last modification) 2021-07-08T11:44:12.492687
...
class DigitalInChannelProvider(DigitalInChannelProvider_pb2_grpc.DigitalInChannelProviderServicer):
    ...
    def __init__(self, channels: List[DigitalInChannel], simulation_mode: bool = True):
        """
        Class initialiser.
    ...
    def switch_to_real_mode(self):
        ...
        self._inject_implementation(DigitalInChannelProviderReal())
    ...
    def Get_NumberOfChannels(self, request, context: grpc.ServicerContext) \
        ...
        Requests the unobservable property Number Of Channels
            The number of digital input channels. This value is 0-indexed, i.e. the first channel has index 0, the second one index 1 and so on.

        :param request: An empty gRPC request object (properties have no parameters)
        :param context: gRPC :class:`~grpc.ServicerContext` object providing gRPC-specific information

        :returns: A response object with the following fields:
            NumberOfChannels (Number Of Channels): The number of digital input channels. This value is 0-indexed, i.e. the first channel has index 0, the second one index 1 and so on.
        """
        ...
        return DigitalInChannelProvider_pb2.Get_NumberOfChannels_Responses(
    ...
    def Get_FCPAffectedByMetadata_ChannelIndex(self, request, context: grpc.ServicerContext) \
        ...
        return DigitalInChannelProvider_pb2.Get_FCPAffectedByMetadata_ChannelIndex_Responses(
            AffectedCalls=[
                silaFW_pb2.String(value="de.cetoni/io/DigitalInChannelProvider/v1/Property/State"),
            ]
        )
