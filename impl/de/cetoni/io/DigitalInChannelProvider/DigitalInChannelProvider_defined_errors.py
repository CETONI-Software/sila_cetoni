...
*Digital In Channel Provider_defined_errors*

:details: DigitalInChannelProvider Defined SiLA Error factories:
    Allows to control one digital input channel of an I/O module

:file:    DigitalInChannelProvider_defined_errors.py
:authors: Florian Meinicke

:date: (creation)          2021-07-08T11:44:14.099572
:date: (last modification) 2021-07-08T11:44:14.099572
...
class InvalidChannelIndex(SiLAExecutionError):
    ...
    def __init__(self, channel_id: int = None, extra_message: str = ""):
        ...
        super().__init__(error_identifier="sila2.de.cetoni/io/DigitalInChannelProvider/v1/DefinedError/InvalidChannelIndex",
                         msg=msg)
