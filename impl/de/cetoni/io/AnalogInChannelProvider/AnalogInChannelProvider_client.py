...
:file:    AnalogInChannelProvider_client.py
:authors: Florian Meinicke

:date: (creation)          2021-07-08T11:41:58.287219
:date: (last modification) 2021-07-08T11:41:58.287219
...
class AnalogInChannelProviderClient:
    ...
    def __init__(self,
        ...
        self.AnalogInChannelProvider_stub = \
            AnalogInChannelProvider_pb2_grpc.AnalogInChannelProviderStub(channel)
    ...
    def Get_NumberOfChannels(self) \
        ...
        try:
            response = self.AnalogInChannelProvider_stub.Get_NumberOfChannels(
                AnalogInChannelProvider_pb2.Get_NumberOfChannels_Parameters()
            )
            logging.debug(
    ...
    def Get_FCPAffectedByMetadata_ChannelIndex(self) \
        ...
        try:
            response = self.AnalogInChannelProvider_stub.Get_FCPAffectedByMetadata_ChannelIndex(
                AnalogInChannelProvider_pb2.Get_FCPAffectedByMetadata_ChannelIndex_Parameters()
            )
            logging.debug(
