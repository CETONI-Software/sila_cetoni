...
from .gRPC import ChannelGatewayService_pb2 as pb2
...
default_dict['GetChannelIdentifiers_Parameters'] = {
    'FeatureIdentifier': silaFW_pb2.String(value='default string')
}

default_dict['GetChannelIdentifiers_Responses'] = {
    'ChannelIdentifiers': [silaFW_pb2.String(value='default string')]
}
