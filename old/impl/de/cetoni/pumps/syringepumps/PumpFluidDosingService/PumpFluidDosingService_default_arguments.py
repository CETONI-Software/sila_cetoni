...
default_dict['SetFillLevel_Parameters'] = {
    'FillLevel': silaFW_pb2.Real(value=1.0),
...
default_dict['DoseVolume_Parameters'] = {
    'Volume': silaFW_pb2.Real(value=1.0),
    'FlowRate': silaFW_pb2.Real(value=1.0)
}
...
default_dict['Subscribe_MaxSyringeFillLevel_Responses'] = {
    'MaxSyringeFillLevel': silaFW_pb2.Real(value=1.0)
}

default_dict['Subscribe_SyringeFillLevel_Responses'] = {
    'SyringeFillLevel': silaFW_pb2.Real(value=1.0)
}

default_dict['Subscribe_MaxFlowRate_Responses'] = {
    'MaxFlowRate': silaFW_pb2.Real(value=1.0)
}
