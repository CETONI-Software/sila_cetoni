...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x18ShutdownController.proto\x12*sila2.de.cetoni.core.shutdowncontroller.v1\x1a\x13SiLAFramework.proto\"\x15\n\x13Shutdown_Parameters\"\x14\n\x12Shutdown_Responses2\xfe\x02\n\x12ShutdownController\x12z\n\x08Shutdown\x12?.sila2.de.cetoni.core.shutdowncontroller.v1.Shutdown_Parameters\x1a+.sila2.org.silastandard.CommandConfirmation\"\x00\x12h\n\rShutdown_Info\x12,.sila2.org.silastandard.CommandExecutionUUID\x1a%.sila2.org.silastandard.ExecutionInfo\"\x00\x30\x01\x12\x81\x01\n\x0fShutdown_Result\x12,.sila2.org.silastandard.CommandExecutionUUID\x1a>.sila2.de.cetoni.core.shutdowncontroller.v1.Shutdown_Responses\"\x00\x62\x06proto3'
  ,
...
_SHUTDOWN_PARAMETERS = _descriptor.Descriptor(
  ...
  full_name='sila2.de.cetoni.core.shutdowncontroller.v1.Shutdown_Parameters',
  filename=None,
  file=DESCRIPTOR,
...
_SHUTDOWN_RESPONSES = _descriptor.Descriptor(
  ...
  full_name='sila2.de.cetoni.core.shutdowncontroller.v1.Shutdown_Responses',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
Shutdown_Parameters = _reflection.GeneratedProtocolMessageType('Shutdown_Parameters', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:sila2.de.cetoni.core.shutdowncontroller.v1.Shutdown_Parameters)
  })
...
Shutdown_Responses = _reflection.GeneratedProtocolMessageType('Shutdown_Responses', (_message.Message,), {
  ...
  '__module__' : 'ShutdownController_pb2'
  # @@protoc_insertion_point(class_scope:sila2.de.cetoni.core.shutdowncontroller.v1.Shutdown_Responses)
  })
...
_SHUTDOWNCONTROLLER = _descriptor.ServiceDescriptor(
  ...
  full_name='sila2.de.cetoni.core.shutdowncontroller.v1.ShutdownController',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='Shutdown',
    full_name='sila2.de.cetoni.core.shutdowncontroller.v1.ShutdownController.Shutdown',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='Shutdown_Info',
    full_name='sila2.de.cetoni.core.shutdowncontroller.v1.ShutdownController.Shutdown_Info',
    index=1,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='sila2.de.cetoni.core.shutdowncontroller.v1.ShutdownController.Shutdown_Result',
    index=2,
    containing_service=None,
    input_type=SiLAFramework__pb2._COMMANDEXECUTIONUUID,
