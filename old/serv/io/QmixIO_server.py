...
:date: (last modification) 2021-07-08T12:20:25.222975
...
class QmixIOServer(BatteryServer):
    ...
    def __init__(self,
        ...
        analog_in_channels = [channel for channel in io_channels if isinstance(channel, AnalogInChannel)]
        ...
        analog_out_channels = [channel for channel in io_channels if isinstance(channel, AnalogOutChannel)]
        ...
        digital_in_channels = [channel for channel in io_channels if isinstance(channel, DigitalInChannel)]
        ...
        digital_out_channels = [channel for channel in io_channels if isinstance(channel, DigitalOutChannel)]
