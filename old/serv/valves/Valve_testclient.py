...
:file:    Valve_testclient.py
:authors: Florian Meinicke

:date: (creation)          2021-07-10T09:27:10.597623
:date: (last modification) 2021-07-10T09:27:10.597623
...
def parse_command_line():
    ...
    parser = argparse.ArgumentParser(
        description="A SiLA2 test client for: Valve")
...
if __name__ == '__main__':
    ...
    # start the client
    sila_client = ValveClient(server_ip=parsed_args.server_ip_address,
    ...
    # results = sila_client.ValveGatewayService_client.Get_FCPAffectedByMetadata_ValveIndex()
    # print("FCPAffectedByMetadata_ValveIndex res: ", results)
