...
:date: (last modification) 2020-12-08T14:26:17.747761
...
class QmixIOClient(SiLA2Client):
    ...
    def SetOutput(self,
                      parameter: de.cetoni.io.DigitalOutChannelController_pb2.SetOutput_Parameters = None) \
            -> de.cetoni.io.DigitalOutChannelController_pb2.SetOutput_Responses:
        """
        ...
        try:
            ...
            response = self.de.cetoni.io.DigitalOutChannelController_stub.SetOutput(parameter)
    ...
    def Subscribe_State(self) \
            -> de.cetoni.io.DigitalInChannelProvider_pb2.Subscribe_State_Responses:
        ...
        return response
    def Subscribe_State(self) \
            -> de.cetoni.io.DigitalOutChannelController_pb2.Subscribe_State_Responses:
        """Wrapper to get property State from the server."""
        # noinspection PyUnusedLocal - type definition, just for convenience
        grpc_err: grpc.Call
