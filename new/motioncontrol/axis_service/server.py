...
class Server(IOServer):
    def __init__(
        ...
        super().__init__(
            ...
            server_description=server_description or "The SiLA 2 driver for CETONI sample handlers and positioning systems",
        ...
        self.axissystempositioncontroller = \
            AxisSystemPositionControllerImpl(axis_system, device_properties, self.child_task_executor)
